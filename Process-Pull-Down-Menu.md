...
**Renumber**: SemTalk Online automatically adds an Index number to a Task. Renumber allows users to reset the Indexing number.

**Reindex**: Changes how Tasks or Sub-Diagrams are indexed and the order they will appear in the **Diagram - Pull-Down** menu found in on the upper right area above the **Stencil**.
