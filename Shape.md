...
Select a **Shape** on a **Diagram** before selecting the **Shape Pull-Down Menu**.

**New**: Shows the available **Shapes** allowed in the active Diagram. Select a Shape to paste it onto your Diagram. A matching Shape will be created that can be edited as needed using the right nouse click Style option.
...
**Delete** (Symbols): Deletes the selected symbol from the drawing sheet.
