...
**Insert (Model)**: Opens a list of available  Tasks, objects, or Events, etc. that are in the local Repository that can be added to the currently opened Process Diagram/ Event Diagram.

**Paste**: Pastes what is in the Clipboard. (Copied or cut information)