...
Model files are stored locally on the specific computer being used. Local models can only be opened and saved from computer where they were saved.
...
**MongoDB**s can be hosted in the Cloud, as well as on your own servers, making them flexible and easy to set up. This is why **MongoDB** was chosen as SemTalk's database system for SemTalk Online outside of Microsoft environments.
